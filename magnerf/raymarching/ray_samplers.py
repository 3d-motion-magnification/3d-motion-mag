...
class RaySamples:
    ...
    def get_weights(self, densities: torch.Tensor, opaque_background=False) -> torch.Tensor:
        ...
        if opaque_background:
            ...
            delta_density = torch.cat(
                [
                    delta_density[..., :-1, :],
                    torch.ones_like(delta_density[..., -1:, :]) * 1e18
                ],dim=-2)
